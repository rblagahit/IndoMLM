	...
	if( isset( $user ) )
	{
		...
		if( $menu != 0 )
		{
			  ...
			  $i % 2 == 0 ? $bgColor = "#FFFFFF" : $bgColor = "#E6E6E6";
	                 ...
	                 echo "      <td width=\"15%\" height=\"25\" align=\"left\" bgcolor=\"$bgColor\"><font face=\"Tahoma\" size=\"1\" color=\"#000080\">{$row['alamat']}</td>\n";
		             ...
		             echo "      <td width=\"10%\" height=\"25\" align=\"left\" bgcolor=\"$bgColor\"><font face=\"Tahoma\" size=\"1\" color=\"#000080\"><a href='admin_genealogy1.php?user={$row['username']}'>Next<font size=\"1\"></td>\n";
     	             echo "    </tr>\n";
			         $i=$i+1;
 		       }
 		             echo "    <tr>\n";
 	                 ...
 	                 echo "  </table>\n";
 	 	             echo " </center>\n";
		             echo "</div>\n";
	                 echo "<p align=\"center\"><a href=\"javascript:history.back()\"><b>Back </b></a> &nbsp;| <a href=\"admin_menu.php\"><b>Back to Admin</b></p>\n";
					 displayFooter();
	                 }
		         else
		         {
